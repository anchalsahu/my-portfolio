  ...
  data() {
    return {
      ...
      experience: [
        {
          ...
          company: "Barclays",
          description:
            "Working on technology which includes Node.JS, React.JS, Typescript, ExpressJS, Microservices, REST API etc",
          startDate: "Dec 2018",
          endDate: "Till Now"
        },
        {
      ...
      responsibility: [
        ...
        {
          id: 2,
          text: "Involvement in Recruitment Process"
        },
        {
          id: 3,
        ...
        {
          id: 4,
          text: "Help Team Members whenever needed"
        },
        {
          id: 5,
